...
<div class="wrap">
	<?php
		echo "<h2>" . __('Courses Management', 'wwtcourses' ) . "</h2>";	
	...
	<?php settings_fields( 'wwtc_courses_options' ); ?>
							...
							<table class="form-table wwtc_default_iframe_table">
								<tbody>
									<tr>
										...
										<td>
											<textarea name="wwtc_courses_data[default_course_iframe]" id="wwtc_default_course_iframe" class="wwtc_default_course_iframe" placeholder="<?php _e( 'Default Shortcode', 'wwtcourses' ); ?>"><?php echo $wwtc_option_default_iframe; ?></textarea>
										</td>
									</tr>
								</tbody>
							</table>
							<table class="form-table wwtc_course_table">
								<tbody>
									...
									?>
										<tr>
											<td>
												<select name="wwtc_courses_data[<?php echo $i; ?>][course]" id="wwtc_course" class="wwtc_select_course" data-id="<?php echo $i; ?>">
											...
											<td>
												<select name="wwtc_courses_data[<?php echo $i; ?>][location]" id="wwtc_booking_location" class="wwtc_select_location" data-id="<?php echo $i; ?>">
											...
											<td>
												...
												<select name="wwtc_courses_data[<?php echo $i; ?>][course_page]" id="wwtc_course_page" class="wwtc_select_course_page multiselect" data-id="<?php echo $i; ?>">
											...
											<td class="course_iframe_td">
												<textarea name="wwtc_courses_data[<?php echo $i; ?>][course_iframe]" id="wwtc_course_iframe" class="wwtc_select_course_iframe" data-id="<?php echo $i; ?>" placeholder="<?php _e( 'Course Shortcode', 'wwtcourses' ); ?>"><?php echo $wwtc_option_course_iframe; ?></textarea>
											</td>
											<td>
									...
									<?php $next_id = $total; ?>
									 <tr class="tr_clone" data-id="<?php echo $next_id; ?>">
										<td>
											<select name="wwtc_courses_data[<?php echo $next_id; ?>][course]" id="wwtc_course" class="wwtc_select_course" data-id="<?php echo $next_id; ?>">
												<option value=""><?php _e( 'Select Course', 'wwtcourses' ); ?></option>
												<?php
												if( is_array($wwtc_courses_list) && !empty($wwtc_courses_list) ){
								                    foreach($wwtc_courses_list as $key => $course_value){
										...
										<td>
											<select name="wwtc_courses_data[<?php echo $next_id; ?>][location]" id="wwtc_booking_location" class="wwtc_select_location" disabled="" data-id="<?php echo $next_id; ?>">
												<option value=""><?php _e( 'Select Location', 'wwtcourses' ); ?></option>
												<?php
								                    $statearr = get_option('wwtc_location_states');
								                    if( !empty( $statearr ) ) {
										...
										<td>
											<?php $fetch_pages = get_pages(); ?>
											<select name="wwtc_courses_data[<?php echo $next_id; ?>][course_page]" id="wwtc_course_page" class="wwtc_select_course_page multiselect" disabled="" data-id="<?php echo $next_id; ?>">
												<option value=""><?php _e( 'Select Page', 'wwtcourses' ); ?></option>
												<?php
													if(!empty($fetch_pages)) {
														foreach ( $fetch_pages as $page ) {
										...
										<td>
											<textarea name="wwtc_courses_data[<?php echo $next_id; ?>][course_iframe]" id="wwtc_course_iframe" class="wwtc_select_course_iframe" disabled="" data-id="<?php echo $next_id; ?>" placeholder="<?php _e( 'Course Shortcode', 'wwtcourses' ); ?>"></textarea>
										</td>
										<td>
